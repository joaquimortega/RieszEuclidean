...
The translation-hull construction belongs to the established theory of
point set dynamical systems; see Lenz--Stollmann \cite{LenzStollmann} and
Bj\"orklund, Hartnick and Pogorzelski \cite{BjorklundHartnickPogorzelski}.
Its applications to sampling and interpolation are developed by
Enstad--Raum \cite{EnstadRaum}. Averaging inequalities over invariant
probability measures on hulls also plays a central role in
\cite{EnstadRaum,EnstadVanVelthoven}. Here we use this framework to
transfer a uniform distance estimate between projections to a stationary
Hilbert space, where a boundary crossing produces the obstruction.
...
\subsection*{Note} The non-existence of Riesz basis of exponentials in balls and triangles has been independently obtained with a different proof by Zhiqiang Wan in \cite{Wan}. We were aware of his result in the final stage of preparing our manuscript. Since the methods are different and there are domains, such as the smooth convex open sets, not covered in \cite{Wan}, we offer this proof here.
...
The topology in \eqref{eq:weak-sets} is the restriction of the
Chabauty--Fell topology; see
\cite[Appendix~A, Proposition~A.1]{BjorklundHartnickPogorzelski}.
Lemma~\ref{lem:hull} is a standard consequence of compactness and
metrizability of that space and continuity of its translation action:
\cite[Proposition~2.2(ii)]{EnstadRaum}, with $U=B(0,\delta/2)$, shows
that the class of $\delta$-separated sets is closed. See also
\cite[Theorem~1.2, Proposition~1.3 and Remark~1.5(c)]{LenzStollmann}
for the Euclidean topology and hull construction. We include a proof
using counting measures.
...
The local matching of centers used in the next proof is the separated
case of \cite[Proposition~2.3]{EnstadRaum}; see also
\cite[Lemma~2.2]{EnstadVanVelthoven}. Compact support of the bumps
then gives strong convergence of the associated projections.
...
Riesz basis for $L^2(\Omega)$. Preservation of the Riesz and frame
properties under hull limits is also established in
\cite[Proposition~3.8 and Theorem~3.9]{EnstadRaum}; for separated
sets the bounds are preserved without loss. Only the uniform projection
estimate will be needed below.
...
The following construction is the usual F\o lner averaging argument for
an invariant probability measure on a compact hull. In the sampling
setting, see \cite[proof of Theorem~2.16, Steps~2--3]{EnstadRaum};
see also the amenability discussion in
\cite[Section~2.3]{EnstadVanVelthoven}. Neither unique ergodicity nor
finite local complexity is needed here.
...
Covariant operator families over point set dynamical systems are studied
in \cite[Sections~2--3]{LenzStollmann}. The construction here uses the
explicit bump kernel to obtain operators on $L^2(X,\mu)$; the next
proof verifies their projection property and norm continuity directly.
...
Related arguments integrating frame inequalities over an invariant hull
measure occur in \cite[Theorem~3.12]{EnstadRaum} and
\cite[Theorem~3.5]{EnstadVanVelthoven}. Those results relate frame
bounds to covolumes. Here the averaged forms
\eqref{eq:average-Q}--\eqref{eq:average-P} instead transfer the
operator-norm distance bound between the two projections, with the same
constant $\gamma$.
...
\bibitem{BjorklundHartnickPogorzelski}
M.~Bj\"orklund, T.~Hartnick and F.~Pogorzelski,
\emph{Aperiodic order and spherical diffraction, I: auto-correlation of
regular model sets},
Proc. Lond. Math. Soc. (3) \textbf{116} (2018), no.~4, 957--996.
\href{https://doi.org/10.1112/plms.12091}{doi:10.1112/plms.12091}.
...
\bibitem{EnstadRaum}
U.~Enstad and S.~Raum,
\emph{A dynamical approach to sampling and interpolation in unimodular
groups},
Trans. Amer. Math. Soc. \textbf{378} (2025), no.~3, 1975--2006.
\href{https://doi.org/10.1090/tran/9326}{doi:10.1090/tran/9326}.
\href{https://arxiv.org/abs/2207.05125}{arXiv:2207.05125}.

\bibitem{EnstadVanVelthoven}
U.~Enstad and J.~T.~van Velthoven,
\emph{On the Calder\'on sum formula for wavelet systems},
preprint, 2026.
\href{https://arxiv.org/abs/2602.10766}{arXiv:2602.10766}.
...
\bibitem{LenzStollmann}
D.~Lenz and P.~Stollmann,
\emph{Delone dynamical systems and associated random operators},
in \emph{Operator Algebras and Mathematical Physics}
(Constan\c{t}a, 2001), Theta, Bucharest, 2003, 267--285.
\href{https://arxiv.org/abs/math-ph/0202042}{arXiv:math-ph/0202042}.
...
\bibitem{Wan}
Z.~Wan,
\emph{Sets with no Riesz bases of exponentials},
preprint, 2026.
\href{https://arxiv.org/abs/2609.16674}{arXiv:2609.16674}.
